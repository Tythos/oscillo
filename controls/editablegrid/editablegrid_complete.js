...
/* --- from EDITABLEGRID_RENDERERS.JS --- */
...
/* --- from EDITABLEGRID_VALIDATORS.JS --- */
...
// The following lines are added to ensure compatibility when loaded from 
// Node.js or directly from browser using require()
module = {};
module.exports = {};
module.exports.EditableGrid = EditableGrid;
//EditableGrid = undefined; // In a perfect world, internel references would be independent.
